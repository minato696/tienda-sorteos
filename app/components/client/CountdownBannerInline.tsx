...
export default function CountdownBannerSingleLine({ 
  ...
  return (
    <div className="relative w-full h-full flex items-center bg-gradient-to-r from-sp-indigo via-sp-blue to-sp-cyan py-1.5">
      ...
      {/* Todo en una sola línea - más compacto pero completo */}
      <div className="container mx-auto px-4 flex justify-center">
        <div className="flex items-center">
          ...
          {/* Contador con elementos reducidos */}
          <div className="flex items-end space-x-3">
            {/* Días */}
            <div className="text-center">
              <div className="bg-white w-9 h-9 rounded flex items-center justify-center shadow-sm">
                <span className="text-sp-indigo font-bold text-lg">{String(days).padStart(2, '0')}</span>
              </div>
              <span className="text-white text-[8px] font-medium block mt-0.5">Días</span>
            </div>
            ...
            <div className="text-center">
              ...
              <span className="text-white text-[8px] font-medium block mt-0.5">Horas</span>
            </div>
            ...
            <div className="text-center">
              ...
              <span className="text-white text-[8px] font-medium block mt-0.5">Min</span>
            </div>
            ...
            <div className="text-center">
              ...
              <span className="text-white text-[8px] font-medium block mt-0.5">Seg</span>
            </div>
          </div>
        </div>
      </div>
